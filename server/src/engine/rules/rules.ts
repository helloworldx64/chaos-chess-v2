import { BoardSquare, Color, Move, Piece, PieceType, Position, RuleCategory, RuleDefinition, RuleDuration, ChoiceType } from '../types.js';
import { inBounds, oppositeColor, randomInt, shuffleArray } from '../../utils/helpers.js';
import { findKing, movePiece, removePiece, pieceAt } from '../board.js';
import { generateRawMoves } from '../moves.js';
...
export const ALL_RULES: RuleDefinition[] = [
...

  {
    ...
    onGetMoves: ctxHelper((ctx, piece: Piece, moves: Move[]) => {
      ...
      return moves.filter(m => {
        if (piece.color === ownerColor) return true;
